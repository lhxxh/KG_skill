...
- `Organism.canonical_name` — UNIQUE
- `Disease.canonical_name` — UNIQUE

### Fulltext Indexes

- `drug_fulltext` on Drug: `[canonical_name, drug_name]`
- `model_fulltext` on Model: `[canonical_name]`
- `type_fulltext` on Type: `[canonical_name, model_type]`
- `organism_fulltext` on Organism: `[canonical_name, organism]`
- `disease_fulltext` on Disease: `[canonical_name, name]`
